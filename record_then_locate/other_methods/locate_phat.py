#!/usr/bin/env python3
"""
locate_phat.py -- offline TDOA sound-source localization, GCC-PHAT weighting.
...
Run:
    python locate_phat.py path/to/recording.wav [true_angle_deg]
"""
...
def weight(R, SIG, REF):
    """GCC-PHAT -- Phase transform: psi = 1 / |R|.
    Discards magnitude, keeps only phase. This is the study's reference method
    and matches the existing doa_compass.py behaviour exactly."""
